...
?>
  <form name="CustomersCustomersConfigure" action="<?php echo $CLICSHOPPING_StatsProductsNoViewed->link('Configure&Process&module=' . $current_module); ?>" method="post">
...
<?php
    ...
    if ($CLICSHOPPING_StatsProductsNoViewed->getConfigModuleInfo($current_module, 'is_uninstallable') === true) {
      echo '<span class="float-md-right">' . HTML::button($CLICSHOPPING_StatsProductsNoViewed->getDef('button_dialog_uninstall'), null, '#', 'warning', ['params' => 'data-toggle="modal" data-target="#ppUninstallModal"']) . '</span>';
    }
?>
    </div>
  </form>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><?php echo $CLICSHOPPING_StatsProductsNoViewed->getDef('dialog_uninstall_title'); ?></h4>
            </div>
...
?>
   <div class="col-md-12 mainTitle"><strong><?php echo $CLICSHOPPING_StatsProductsNoViewed->getConfigModuleInfo($current_module, 'title'); ?></strong></div>
      <div class="adminformTitle">
        <div class="row">
          <div class="separator"></div>
          <div class="col-md-12">
